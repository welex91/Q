...
replfile=repl.csv 
srcfile=tmpl_s_to_f_random.c
foo s_to_f_random_I4 $srcfile $replfile "$OUTDIR" s_to_f_random_I4.c
foo s_to_f_random_I8 $srcfile $replfile "$OUTDIR" s_to_f_random_I8.c
...
foo xfer_I1_I8  $srcfile $replfile $OUTDIR xfer_I1_I8.c
foo xfer_I2_I8  $srcfile $replfile $OUTDIR xfer_I2_I8.c
foo xfer_I4_I8  $srcfile $replfile $OUTDIR xfer_I4_I8.c
foo xfer_I8_I8  $srcfile $replfile $OUTDIR xfer_I8_I8.c
foo xfer_F4_I8  $srcfile $replfile $OUTDIR xfer_F4_I8.c
foo xfer_F8_I8  $srcfile $replfile $OUTDIR xfer_F8_I8.c
...
foo conv_I8_to_I2 $srcfile $replfile "$OUTDIR" conv_I8_to_I2.c
...
foo conv_I8_to_I2 $srcfile $replfile "$OUTDIR" nn_conv_I8_to_I2.c
...
replfile=repl7.csv
srcfile=tmpl_crc32.c
foo crc32_I4 $srcfile $replfile "$OUTDIR" crc32_I4.c
foo crc32_I8 $srcfile $replfile "$OUTDIR" crc32_I8.c
