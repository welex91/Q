...
#include "./AUTOGEN/GENFILES/xfer_I1_I8.h"
#include "./AUTOGEN/GENFILES/xfer_I2_I8.h"
#include "./AUTOGEN/GENFILES/xfer_I4_I8.h"
#include "./AUTOGEN/GENFILES/xfer_I8_I8.h"
#include "./AUTOGEN/GENFILES/xfer_F4_I8.h"
#include "./AUTOGEN/GENFILES/xfer_F8_I8.h"
...
// STOP FUNC DECL
{
  ...
  if ( src_fld_rec.fldtype == SC ) {
    ...
    filesz = (len+1) * dst_nR; // TODO: Reconcile the +1 stuff
  }
...
#include "incl_xfer_F8.c"
	...
	case I4 : 
	  ...
	  break;
	case I8 : 
	  xfer_SC_I8(src_fld_X, src_fld_rec.len, src_nR, dst_idx_X, nn_dst_idx_X, 
	      dst_nR, dst_fld_X);
	  break;
...
#define BUFLEN 32
  ...
  zero_fld_rec(&dst_fld_rec); 
  dst_fld_rec.fldtype = src_fld_rec.fldtype;
  dst_fld_rec.len    = src_fld_rec.len;
  ...
  /* TODO: Need to use dict_fld instead of dict_tbl_id. P1 
