...
// STOP FUNC DECL
{
  ...
  if ( strcmp(argv[1], "list_files") == 0 ) {   /* DEPRECATED */
    if ( argc != 3 ) { go_BYE(-1); }
  ...
  else if ( strcmp(argv[1], "list_tbls") == 0 ) {   /* DONE LUA */
    if ( argc != 2 ) { go_BYE(-1); }
    status = list_tbls(); cBYE(status);
  }
  /* TODO P1 
     else if ( strcmp(argv[1], "orphan_files") == 0 ) {  THINK *
     if ( argc != 3 ) { go_BYE(-1); }
     status = orphan_files(argv[2]); cBYE(status);
     }
   */
  else if ( strcmp(argv[1], "set_ddir") == 0 ) { /* DEPRECATED */ 
    if ( argc != 4 ) { go_BYE(-1); }
    status = set_ddir(argv[2], argv[3]); cBYE(status);
  }
  else if ( strcmp(argv[1], "get_ddir") == 0 ) { /* DEPRECATED */ 
    if ( argc != 3 ) { go_BYE(-1); }
  ...
  else if ( strcmp(argv[1], "is_ddir") == 0 ) {/* DEPRECATED */ 
    if ( argc != 3 ) { go_BYE(-1); }
    int ddir_id;
  ...
  else if ( strcmp(argv[1], "is_nn_fld") == 0 ) {  /* DONE */
    if ( argc != 4 ) { go_BYE(-1); }
    status = is_aux_fld(argv[2], argv[3], "nn", &fld_id, rslt_buf); 
    cBYE(status);
  }
  else if ( strcmp(argv[1], "is_aux_fld") == 0 ) {  /* DONE */
    if ( argc != 5 ) { go_BYE(-1); }
  ...
  else if ( strcmp(argv[1], "file_to_fld") == 0 ) {  /* DEPRECATED */
    if ( argc != 3 ) { go_BYE(-1); }
    status = file_to_fld(argv[2], &fld_id, rslt_buf, sz_rslt_buf);
    cBYE(status);
  }
  else if ( strcmp(argv[1], "get_nR") == 0 ) { /* DONE */
    if ( argc != 3 ) { go_BYE(-1); }
  ...
  else if ( strcmp(argv[1], "add_fld") == 0 ) {   /* DONE */
    if ( argc != 5 ) { go_BYE(-1); }
    status = ext_add_fld(argv[2], argv[3], argv[4]);
    cBYE(status);
  }
  else if ( strcmp(argv[1], "dup_fld") == 0 ) {   /* DONE */
    if ( argc != 5 ) { go_BYE(-1); }
    status = dup_fld(argv[2], argv[3], argv[4]);
    cBYE(status);
  }
  else if ( strcmp(argv[1], "delete") == 0 ) {   /* DONE */
    switch ( argc ) { 
  ...
  else if ( strcmp(argv[1], "rename") == 0 ) {   /* DONE */
    switch ( argc ) { 
  ...
  else if ( strcmp(argv[1], "drop_nn_fld") == 0 ) {   /* DONE */
    if ( argc != 4 ) { go_BYE(-1); }
    status = drop_aux_fld( argv[2], argv[3], "nn", -1); cBYE(status);
  }
  else if ( strcmp(argv[1], "drop_aux_fld") == 0 ) {   /* DONE */
    if ( argc != 5 ) { go_BYE(-1); }
    status = drop_aux_fld( argv[2], argv[3], argv[4], -1); cBYE(status);
  }
  else if ( strcmp(argv[1], "mk_nn_fld") == 0 ) {   /* DONE */
    if ( argc != 6 ) { go_BYE(-1); }
    status = mk_nn_fld(argv[2], argv[3], argv[4], argv[5]); cBYE(status);
  }
  else if ( strcmp(argv[1], "break_nn_fld") == 0 ) {   /* DONE */
    if ( argc != 6 ) { go_BYE(-1); }
  ...
  else if ( strcmp(argv[1], "approx_quantile") == 0 ) {   /* DONE */
    if ( argc != 8 ) { go_BYE(-1); }
    int is_good;
    long long num_uq_I8;
    double accuracy_F8;
  ...
  else if ( strcmp(argv[1], "approx_frequent") == 0 ) {   /* DONE */
    if ( argc != 8 ) { go_BYE(-1); }
    int is_good;
    long long num_uq_I8;
    double accuracy_F8;
  ...
  else if ( strcmp(argv[1], "countf") == 0 ) {  /* DONE */
  ...
  else if ( strcmp(argv[1], "fop") == 0 ) {  /* DONE */
    if ( argc != 5 ) { go_BYE(-1); }
    status = fop(argv[2], argv[3], argv[4]); cBYE(status);
  }
  else if ( strcmp(argv[1], "sortf1f2") == 0 ) { /* DONE */ 
    if ( argc != 6 ) { go_BYE(-1); }
    status = sortf1f2(argv[2], argv[3], argv[4], argv[5]); cBYE(status);
  }
  else if ( strcmp(argv[1], "mv_fld") == 0 ) { /* DONE */ 
    if ( argc != 5 ) { go_BYE(-1); }
    status = mv_fld(argv[2], argv[3], argv[4]);
    cBYE(status);
  }
  else if ( strcmp(argv[1], "f_to_s") == 0 ) { /* DONE */ 
    if ( argc == 5 ) { 
  ...
  else if ( strcmp(argv[1], "f1f2_to_s") == 0 ) { /* DONE */ 
    if ( argc != 6 ) { go_BYE(-1); }
    status = f1f2_to_s(argv[2], argv[3], argv[4], argv[5], rslt_buf, sz_rslt_buf);
    cBYE(status);
  }
  else if ( strcmp(argv[1], "rng_join") == 0 ) { /* GRAMMAR */
    if ( argc != 9 ) { go_BYE(-1); }
  ...
  else if ( strcmp(argv[1], "crossprod") == 0 ) {  /* GRAMMAR */
    if ( argc != 11 ) { go_BYE(-1); }
    status = crossprod(argv[2], argv[3], argv[4], argv[5], argv[6], 
        argv[7], argv[8], argv[9], argv[10]);
    cBYE(status);
  }
  else if ( strcmp(argv[1], "app_tbl") == 0 ) {   /* DONE */
    if ( argc != 4 ) { go_BYE(-1); }
    status = app_tbl(argv[2], argv[3]);
    cBYE(status);
  }
  else if ( strcmp(argv[1], "t1f1t2f2opt3f3") == 0 ) {  /* DONE*/
    if ( argc != 10 ) { go_BYE(-1); }
  ...
  /* TODO P0 WHY DID THIS DISAPPEAR 
     else if ( strcmp(argv[1], "is_A_in_b") == 0 ) {  // IGNORE 
     if ( argc != 7 ) { go_BYE(-1); }
     status = is_A_in_b(argv[2], argv[3], argv[4], argv[5], argv[6]);
     cBYE(status);
     }
   */
  else if ( strcmp(argv[1], "percentiles") == 0 ) {  /* DONE */
    if ( argc != 6 ) { go_BYE(-1); }
    status = percentiles(argv[2], argv[3], argv[4], argv[5]);
    cBYE(status);
  }
  else if ( strcmp(argv[1], "is_a_in_b") == 0 ) {  /* DONE */
    if ( argc != 9 ) { go_BYE(-1); }
    status = is_a_in_b(argv[2], argv[3], argv[4], argv[5], argv[6], 
        argv[7], argv[8]); 
    cBYE(status);
  }
  else if ( strcmp(argv[1], "dir_is_a_in_b") == 0 ) {  /* DEPRECATED */
    if ( argc != 12 ) { go_BYE(-1); }
    status = dir_is_a_in_b(argv[2], argv[3], argv[4], argv[5], argv[6], 
        argv[7], argv[8], argv[9], argv[10], argv[11]);
    cBYE(status);
  }
  else if ( strcmp(argv[1], "srt_join") == 0 ) {  /* DONE */
    if ( argc != 9 ) { go_BYE(-1); }
    status = srt_join(argv[2], argv[3], argv[4], argv[5], argv[6], 
        argv[7], argv[8]);   
    cBYE(status);
  }
  else if ( strcmp(argv[1], "no_op") == 0 ) {  /* DONE */
    // Nothing to do except log parameters
  }
  else if ( strcmp(argv[1], "stop_compound") == 0 ) { /* DONE */
    if ( argc != 4 ) { go_BYE(-1); }
  ...
  if ( getenv("Q_RUN_TIME_CHECKS") != NULL ) {
    if ( strcmp(getenv("Q_RUN_TIME_CHECKS"), "TRUE") == 0 ) { /* IGNORE */
