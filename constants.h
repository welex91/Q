...
/* Note that OPT_NUM_SCALARS should be 8 or some such but it needs to be
 * debugged fully especially for value=0. TODO P2 */
#define OPT_NUM_SCALARS 128 /* above this we switch to hash implementation */
